...
export default {
  ...
  emits: ['click', 'moved', 'drag-start', 'drag', 'drag-end'],
  setup(props, { emit, attrs, slots }) {
    const { fixed, disabled, clickTolerance, hint, ctrl, noctrl, stopEvent } =
      toRefs(props);

    const { moving, positionStyle, elementRef, draggableCallbacks } =
      useDraggable({
        clickTolerance,
        fixed,
        emit
