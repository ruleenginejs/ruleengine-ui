  ...
  theme: {
    extend: {
      colors: {
        ...
        "graph-node-header-brown-background": "var(--v-graph-node-header-brown-background)",
        "graph-node-header-indigo-background": "var(--v-graph-node-header-indigo-background)",
        "graph-node-header-orange-background": "var(--v-graph-node-header-orange-background)",
        "graph-node-header-pink-background": "var(--v-graph-node-header-pink-background)",
        "graph-node-header-purple-background": "var(--v-graph-node-header-purple-background)",
        "graph-node-header-red-background": "var(--v-graph-node-header-red-background)",
        "graph-node-header-teal-background": "var(--v-graph-node-header-teal-background)",
        "graph-node-header-yellow-background": "var(--v-graph-node-header-yellow-background)",
